...
export const softSkills = [
  {
    term: "Disciplinado",
    description:
      "Comprometido com prazos e tarefas, mantendo uma rotina organizada e focada em metas e objetivos.",
  },
  {
    term: "Empatia",
    description:
      "Capacidade de compreender e se colocar no lugar dos outros, promovendo um ambiente de trabalho harmonioso e solidário.",
  },
  {
    term: "Honesto",
    description:
      "Comprometido com a verdade e a transparência em todas as interações, construindo relações de confiança e integridade.",
  },
  {
    term: "Organizado",
    description:
      "Habilidade de gerenciar o tempo e recursos de forma eficiente, mantendo documentos, tarefas e projetos estruturados e acessíveis.",
  },
  {
    term: "Paciente",
    description:
      "Capaz de lidar com situações desafiadoras e mudanças inesperadas sem perder a calma, mantendo o foco e a clareza nas decisões.",
  },
  {
    term: "Resiliência",
    description:
      "Capacidade de enfrentar desafios e superar adversidades com persistência, mantendo a motivação e o foco.",
  },
  {
    term: "Resolução de problemas",
    description:
      "Habilidade de analisar situações complexas, identificar a raiz dos problemas e desenvolver soluções eficazes e criáticas.",
  },
  {
    term: "Respeitoso",
    description:
      "Valoriza a diversidade de opiniões e experiências, promovendo um ambiente de trabalho inclusivo e colaborativo.",
  },
  {
    term: "Trabalho em Equipe",
    description:
      "Colaborativo e capaz de integrar-se em grupos diversos, valorizando as contribuições de cada membro para alcançar objetivos comuns.",
  },
];
